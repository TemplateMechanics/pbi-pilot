...
| **Restart** PBI Desktop | `Restart-PBIDesktop.ps1` | `.\scripts\Restart-PBIDesktop.ps1` |
...
- **After editing PBIR files**: Run `Restart-PBIDesktop.ps1` (PBIR changes require a restart).
